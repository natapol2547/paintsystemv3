...
| [PS-091](tickets/PS-091-selection-model-and-overlays.md) | Selection model and overlays. Slices 1 to 4 done: model, mask, stroke clipping and overlays; tools come with 093 | L | 050 092 096 |
